...
public class CFAlertDialog extends AppCompatDialog {
    ...
    private void setupSubviews(View view) {
        ...
        cfDialogBackground = view.findViewById(R.id.cfdialog_background);
        setupBackground();

        cfDialogContainer = view.findViewById(R.id.cfdialog_container);
    ...
    private void setupBackground() {
        ...
        cfDialogBackground.setOnClickListener(v -> {
    ...
    private void setupCardBehaviour() {
        ...
        switch (params.dialogStyle) {
            ...
            case NOTIFICATION:
                ...
                SwipeToHideViewListener cardSwipeListener = new SwipeToHideViewListener(dialogCardView, params.cancelable, () -> CFAlertDialog.super.dismiss());
    ...
    public void setContentImageDrawable(Drawable imageDrawable) {
        if (imageDrawable != null) {
            LayoutInflater layoutInflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ImageView imageView = layoutInflater.inflate(R.layout.cfdialog_imageview_header, cfDialogHeaderLinearLayout).findViewById(R.id.cfdialog_imageview_content);
    ...
    public void setItems(String[] items, final OnClickListener onClickListener) {
        ...
        if (items != null && items.length > 0) {
            ...
            for (int i = 0; i < items.length; i++) {
                ...
                TextView itemTextView = view.findViewById(R.id.cfdialog_selectable_item_textview);
    ...
    public void setSingleSelectItems(String[] singleSelectItems, int selectedItem, final OnClickListener onClickListener) {
        if (singleSelectItems != null && singleSelectItems.length > 0) {
            selectableItemsContainer.removeAllViews();
            selectableItemsContainer.setVisibility(View.VISIBLE);
            RadioGroup radioGroup = getLayoutInflater().inflate(R.layout.cfdialog_single_select_item_layout, selectableItemsContainer)
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            params = new CFAlertDialog.DialogParams();
        ...
        public CFAlertDialog.Builder setBackgroundResource(@ColorRes int backgroundResource) {
            this.params.backgroundColor = ResourcesCompat.getColor(this.params.context.getResources(), backgroundResource, null);
            return this;
        }

        public CFAlertDialog.Builder setBackgroundColor(@ColorInt int backgroundColor) {
            this.params.backgroundColor = backgroundColor;
            return this;
        }

        public CFAlertDialog.Builder setDialogBackgroundResource(@ColorRes int backgroundResource) {
            this.params.dialogBackgroundColor = ResourcesCompat.getColor(this.params.context.getResources(), backgroundResource, null);
            return this;
        }

        public CFAlertDialog.Builder setDialogBackgroundColor(@ColorInt int backgroundColor) {
            this.params.dialogBackgroundColor = backgroundColor;
            return this;
        }

        public CFAlertDialog.Builder setCornerRadius(float cornerRadius) {
            this.params.dialogCornerRadius = cornerRadius;
            return this;
        }

        public CFAlertDialog.Builder setOuterMargin(int margin) {
            this.params.dialogOuterMargin = margin;
            return this;
        }

        public CFAlertDialog.Builder setMessage(CharSequence message) {
            this.params.message = message;
            return this;
        }

        public CFAlertDialog.Builder setTitle(CharSequence title) {
            this.params.title = title;
            return this;
        }

        public CFAlertDialog.Builder setMessage(@StringRes int messageId) {
            this.params.message = params.context.getString(messageId);
            return this;
        }

        public CFAlertDialog.Builder setTitle(@StringRes int titleId) {
            this.params.title = params.context.getString(titleId);
            return this;
        }

        public CFAlertDialog.Builder setTextColor(@ColorInt int color) {
            this.params.textColor = color;
            return this;
        }

        public CFAlertDialog.Builder setContentImageDrawable(@DrawableRes int contentImageDrawableId) {
            this.params.contentImageDrawableId = contentImageDrawableId;
            this.params.contentImageDrawable = null;
            return this;
        }

        public CFAlertDialog.Builder setContentImageDrawable(Drawable contentImageDrawable) {
            this.params.contentImageDrawable = contentImageDrawable;
            this.params.contentImageDrawableId = -1;
            return this;
        }

        public CFAlertDialog.Builder setIcon(@DrawableRes int iconDrawableId) {
            this.params.iconDrawableId = iconDrawableId;
            this.params.iconDrawable = null;
            return this;
        }

        public CFAlertDialog.Builder setIcon(Drawable iconDrawable) {
            this.params.iconDrawable = iconDrawable;
            this.params.iconDrawableId = -1;
            return this;
        }

        public CFAlertDialog.Builder onDismissListener(OnDismissListener onDismissListener) {
            this.params.onDismissListener = onDismissListener;
            return this;
        }

        public CFAlertDialog.Builder setDialogStyle(CFAlertStyle style) {
         ...
         * @param textGravity @see android.view.Gravity
         */
        public CFAlertDialog.Builder setTextGravity(int textGravity) {
            this.params.textGravity = textGravity;
            return this;
        }

        public CFAlertDialog.Builder addButton(String buttonText, @ColorInt int textColor, @ColorInt int backgroundColor, CFAlertActionStyle style, CFAlertActionAlignment alignment, OnClickListener onClickListener) {
        ...
        public CFAlertDialog.Builder setItems(String[] items, OnClickListener onItemClickListener) {
            params.items = items;
            params.onItemClickListener = onItemClickListener;
            return this;
        }

        public CFAlertDialog.Builder setMultiChoiceItems(String[] items, boolean[] selectedItems, OnMultiChoiceClickListener onMultiChoiceClickListener) {
        ...
        public CFAlertDialog.Builder setSingleChoiceItems(String[] items, int selectedItem, OnClickListener onItemClickListener) {
        ...
        public CFAlertDialog.Builder setHeaderView(View headerView) {
            this.params.headerView = headerView;
            this.params.headerViewId = -1;
            return this;
        }

        public CFAlertDialog.Builder setHeaderView(@LayoutRes int headerViewId) {
            this.params.headerViewId = headerViewId;
            this.params.headerView = null;
            return this;
        }

        public CFAlertDialog.Builder setFooterView(View footerView) {
            this.params.footerView = footerView;
            this.params.footerViewId = -1;
            return this;
        }

        public CFAlertDialog.Builder setFooterView(@LayoutRes int footerViewId) {
         ...
         * @param cancelable
         */
        public CFAlertDialog.Builder setCancelable(boolean cancelable) {
            this.params.cancelable = cancelable;
            return this;
        }

        public CFAlertDialog.Builder setAutoDismissAfter(long duration) {
