...
//        popupWindow.setOutsideTouchable(false);
        ...
        createAlertDialog(currentActivity, parentRelativeLayout, gravity);
...
//        popupWindow.showAtLocation(currentActivity.getWindow().getDecorView().getRootView(), gravity, 0, 0);
    ...
    private void createAlertDialog(final Activity activity, View view, int gravity) {

        insightDialog = new AlertDialog.Builder(activity).setCancelable(true).create();
        insightDialog.show();
        ...
        insightDialog.getWindow().setAttributes(lp);
        insightDialog.getWindow().setBackgroundDrawableResource(R.color.TRANSPARENT);
        insightDialog.setContentView(view);
